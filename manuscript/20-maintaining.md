...
If you have read this far, the odds are overwhelming that you are the Visionary. Integrators rarely need this book: if one had been running your operations, half of what we have built together would have existed years ago. Be glad of your wiring, because it is what built the business. The appetite for risk, the restlessness, the refusal to accept that things are as good as they can be: no business starts without those. But hold the other truth alongside it. The same wiring is now the biggest threat to the machine. The urge to be involved, to tweak, to challenge, to meddle, is not a character flaw you can discipline away forever. It is your factory setting. The rest of this chapter is how you point it somewhere useful.
...
Train your people to operate the systems and to improve them. Teach the operator, not just the tool. Build a culture where anyone can say "this bit is clunky" and have it actually fixed, where improvements are logged so everyone can see how things are evolving, where the people closest to the work are trusted to make it better.

There is a name for the culture you are aiming at. In Extreme Ownership, the former US Navy SEALs Jocko Willink and Leif Babin argue that the strongest teams are those where ownership is pushed down to the people doing the work, not hoarded at the top.[^extremeownership] In an automatic business it arrives in two stages. First, set the standard for how problems reach you: nobody brings you a problem on its own. They bring the problem, three possible fixes, and the one they recommend, with their reasoning. You will be surprised how often their answer is better than the one you would have given from the pit wall. Then, once that habit is embedded, go further. Define the constraints, the budget, the guardrails, the things that must never break, and empower them to make the fixes themselves, without asking. The problems start being solved by the people who found them, and you hear about it afterwards, in the log.

When you do this, the machine improves without you being the one improving it. Even the upkeep of your automatic business stops depending on you. That is the last knot untied.
...
```{=typst}
#v(0.5em)
#align(right, image("images/marginalia/mark-ch20-arrow-off-page.png", width: 1.2in))
#v(0.1em)
```
...
[^extremeownership]: Jocko Willink and Leif Babin, *Extreme Ownership: How U.S. Navy SEALs Lead and Win* (2015).

[^rocketfuel]: Gino Wickman and Mark C. Winters, *Rocket Fuel: The One Essential Combination That Will Get You More of What You Want from Your Business* (2015). Their estimate is that roughly 22 per cent of people are wired as Visionaries and only around 5.5 per cent as Integrators: approximately four Visionaries for every Integrator.
