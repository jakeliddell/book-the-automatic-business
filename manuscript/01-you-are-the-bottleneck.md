...
```{=typst}
#v(-0.5em)
#align(left, image("images/marginalia/mark-ch01-underline.png", width: 1.1in))
#v(0.2em)
```
...
There is a comforting lie in busyness, too. Crossing things off a list feels like progress. It produces a little hit of satisfaction. (It actually releases dopamine.) But busy and effective are not the same thing, and you can be flat out from dawn to dusk while building something fragile, dependent and impossible to scale. Motion is not the same as movement.
