...
So when something keeps going wrong there, the instinct is to fix the person. More training. A stern word about being more careful. A new rule pinned to the wall. It almost never works, because the fault is not really in the person. It is in the structure. You are asking a tired human to do a repetitive, fiddly task perfectly, every time, forever, and humans are simply not built for that. They forget. They tire. They skip a step because they are rushing to beat the lunch queue. Or they just 
