...
> **Try this.** Choose one task that currently only you do, and that comes around every week. Write a single sentence describing the result it should produce every time, with no input from you. For example: "Every new enquiry gets a personal reply within the hour, with the right information, logged in one place." You have just done the architect's job for the first time. You have described an outcome instead of doing a task. We are going to do a great deal more of that. (If you're enjoying this, write down a few more, while they're fre
