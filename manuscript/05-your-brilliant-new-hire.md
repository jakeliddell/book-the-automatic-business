...
And two rules that matter. Verify anything that carries risk before it leaves the building. And understand how your AI has been set up before you paste in anything confidential that you would not hand to a stranger, because you could be training a model, and then you cannot be sure where it ends up.
