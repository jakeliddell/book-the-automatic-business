...
And if it is neither, if it needs some understanding or judgement but follows no fixed rule, that is the AI band. Hand it to AI, with a human glance over its shoulder sized to the stakes.  (Remember, AI does not need to be perfect every time.  It just needs to be about as good as a hum
