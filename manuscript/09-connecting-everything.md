...
The whole idea fits in one line. When something happens in one tool, do something in another. The first half is the trigger. The second half is the action.
