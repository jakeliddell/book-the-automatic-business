...
They are playing outside their lane, in order to capture more revenue from business owners who want to take the easy, no-thought, option.  When a niche software product claims it can support you outside the delivery lane they grew up in, be careful to fully evaluate that they can do all you will want them to do.  At the very least, make sure it has a mature API wi
