...
As a previous reseller of ActiveCampaign, an implementor of Salesforce, someone who tried to use PipeDrive (it didn't work well), and done a handful of Hubspot migrations, my recommendation is HighLevel, which is why I currently resell it.  (For full transparency, I used to be an ActiveCampaign reseller, but moved away once I could no longer recommend it.)  But no business tool is perfect for every business.  You shouldn't assume one tool is right for you or your industry.  Get someone who knows the tools to help you choo
