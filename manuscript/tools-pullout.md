...
But also ask yourself a different question.  "Where am I now?" If you've already invested time and money in implementing a tool properly, there's a lot more at stake in switching: technical work, risk of disruption, cultural impact.  But a secret: from my experience of many, many clients, most haven't touchBut if you've seen the image of SaaS Spaghetti, and it resonated, you know you need to do some work; the only question is how you structure the change.
