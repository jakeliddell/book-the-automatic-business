...
Proposals with e-signatures (PandaDoc and its rivals, or build it into your). In each case the same rule applies: pick one, connect it to your hub, and let it talk to everything else.
