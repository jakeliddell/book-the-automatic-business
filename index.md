# Important: Read This First {.unnumbered}

I almost became a physicist.
...
But I was tired. Tired of years of education, of exams, of being told what to learn and when. So before university I took a year out, and I went to work for a company called ICL (or International Computers Limited, a very British company).

If you are too young to remember ICL, it was one of the most innovative technology companies Britain ever produced, a giant of the mainframe era. While I was there, Fujitsu bought it. I landed in the R&D division: fifty or so computer science boffins building some of the most advanced hardware and software anywhere in the world at the time. My new team mates were building, for example, software that mapped out highly complex relationships analysis used to convict perpetrators of serious crimes, and low-level caching hardware to sit between CPUs and disks to massively accelerate performance of expensive mini-computers.  My job, right at the bottom of the pile, was systems administration. In plain English, that meant keeping the kit running while fifty brilliant people did their level best to hammer it into the ground.
...
The first is a thing it took me years to say out loud, because it sounds too simple to be important: software has always been automation. That is all software has ever been. A way of getting a machine to do something a human would otherwise do by hand, over and over again. What we now breathlessly call "AI" is not a break from that. It is the newest, cleverest layer on a road businesses have been travelling for decades, since long before the internet, since before that fax machine. I have spent more than thirty-five years on that road. Half of it in the largest companies in the world, designing systems for banks, utilities and tech giants. Half of it doing the very same thing for businesses the size of yours.

Let me be more specific about that first half, because it explains everything about the second.

For years I worked on some of the largest technology programmes there are. Payment systems for entire countries, many times. Rebuilding the company that delivered gas to a fifth of a nation. Building a bank from scratch. Work at that scale teaches you how systems really behave, and I would not trade a day of it.

But it taught me something else, and it is the reason I left. We were not telling clients the truth. Not lies, exactly; something quieter. We did not give best-practice advice. We gave the advice that sold more consultancy. Everyone in the room knew the difference, and nobody said it out loud.

So in 2006 I walked away, and I made myself one rule: give every piece of advice as if I owned part of the business receiving it. I have kept that rule for twenty years. It has kept me honest, and it helps me sleep at night. Every page of this book was written under it.

The second reason is that it tells you what kind of book this is. I am not a guru. I am not going to sell you fairy dust, a magic tool, or a five-minute fix. What you are holding is drawn from the frontline of real businesses just like yours. Businesses fed up with the chaos, the waste, and the endless effort of simply staying afloat. I am going to be honest with you, including in the places where honesty is uncomfortable.

So let me tell you what I think is going on with you.

You are good at what you do. Very good. You built this business on the back of that talent, and for a while it worked beautifully. But somewhere along the way, everything started to depend on you. You are the one who knows how it all works. You are the one every decision runs through. Your team cannot move without checking first. And without ever choosing it, you have become the bottleneck in your own business.

You have probably already tried to fix it. You bought the CRM and watched it turn into a database nobody fills in: a place leads go to die. You hired an assistant and ended up doing half their job, as well as your own. You started writing down how things are done, then got pulled away, and all that good work is still sitting in a folder somewhere, ninety percent finished. You sat through a webinar about AI and came away more confused than when you started. It all looked amazing, but without a clear plan, you didn't know how to actually _use_ it.  None of it stuck.

If that stings a little, good. It means you are in the right place. Because none of it stuck for one reason, and it is not that you did not try hard enough. It is that every one of those fixes treated the symptom and left the cause untouched. Almost everyone does the same. There is even a shape to the loop you are caught in, and once you see it you cannot unsee it.
...
That is not fear talking. It is simply what I have watched happen for thirty-five years.  And the thing is, the cycle of change is getting faster.
